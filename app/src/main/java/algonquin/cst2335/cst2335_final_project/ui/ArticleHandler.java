 ...
 */
public class ArticleHandler extends RecyclerView.Adapter<ArticleHandler.ArticleViewHolder> {
    /**
     ...
     */
    public ArticleHandler(OnArticleClickListener onArticleClickListener) {
